  ...
  return (
    <>
      <footer className="relative">
        {/* Background Gradient */}
        <div className="relative bg-[linear-gradient(115deg,#fff1be_28%,#ee87cb_70%,#b060ff_100%)] sm:bg-[linear-gradient(145deg,#fff1be_28%,#ee87cb_70%,#b060ff_100%)]">
          {/* Glass Overlay */}
          <div className="absolute inset-2 rounded-4xl bg-white/80 backdrop-blur-sm"></div>

          <div className="relative px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
              {/* CTA Section */}
              <div className="pt-20 pb-16 text-center sm:pt-24 sm:pb-28">
                <p className="text-xs font-semibold tracking-widest text-gray-500 uppercase">
                  Get started
                </p>

                <h2 className="mt-6 text-3xl sm:text-5xl font-medium tracking-tight text-gray-950">
                  Ready to dive in? <br />
                ...
                <div className="mt-8">
                  <a
                    href="#"
                    className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-gray-950 text-white font-medium hover:bg-gray-800 transition"
                  >
                    Get started
                  </a>
                </div>
              ...
              <div className="absolute inset-x-0 z-10">
                <div className="absolute w-full ">
                  <div className="absolute inset-x-0 -top-6 md:-top-7 border-t border-black/5"></div>
                  <div className="absolute inset-x-0 -top-4 md:-top-9 border-t border-black/5"></div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-6 gap-10">
                <div className="col-span-2">
                  <div className="relative">
                    <svg
                      viewBox="0 0 15 15"
                      aria-hidden="true"
                      className="hidden md:block sm:absolute size-[15px] fill-black/10 -top-[35px] -left-2"
                    >
                    ...
                    <svg
                      viewBox="0 0 15 15"
                      aria-hidden="true"
                      className="hidden md:block sm:absolute size-[15px] fill-black/10 -top-[35px] left-[120px]"
                    >
                      <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                    </svg>
                    <svg
                ...
                <div>
                  ...
                  <ul className="mt-7 space-y-5 text-sm">
                    <li>
                      <a href="#" className="font-medium text-gray-950 hover:text-gray-950/75">Pricing</a>
                    </li>
                    <li>
                      <a href="#" className="font-medium text-gray-950 hover:text-gray-950/75">Analysis</a>
                    </li>
                    <li>
                      <a href="#" className="font-medium text-gray-950 hover:text-gray-950/75">API</a>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="mt-7 space-y-5 text-sm">
                    <li>
                      <a href="#" className="font-medium text-gray-950 hover:text-gray-950/75">Careers</a>
                    </li>
                    <li>
                      <a href="#" className="font-medium text-gray-950 hover:text-gray-950/75">Blog</a>
                    </li>
                    <li>
                      <a href="#" className="font-medium text-gray-950 hover:text-gray-950/75">Company</a>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="mt-7 space-y-5 text-sm">
                    <li>
                      <a href="#" className="font-medium text-gray-950 hover:text-gray-950/75">Help center</a>
                    </li>
                    <li>
                      <a href="#" className="font-medium text-gray-950 hover:text-gray-950/75">Community</a>
                    </li>
                  </ul>
                </div>

                <div>
                  <p className="text-sm font-medium text-gray-500">Legal</p>
                  <ul className="mt-7 space-y-5 text-sm">
                    <li>
                      <a href="#" className="font-medium text-gray-950 hover:text-gray-950/75">Terms of service</a>
                    </li>
                    <li>
                      <a href="#" className="font-medium text-gray-950 hover:text-gray-950/75">Privacy Privacy</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="absolute inset-x-0 z-10">
                <div className="absolute w-full ">
                  <div className="absolute inset-x-0 top-10 md:top-8 border-t border-black/5"></div>
                  <div className="absolute inset-x-0 top-8 md:top-6 border-t border-black/5"></div>
                </div>
              </div>

              <div className="flex flex-col md:flex-row justify-between items-center py-6 pb-[87px] pt-12">
                <div className="relative">
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="hidden md:block sm:absolute size-[15px] fill-black/10 -top-5.75 -left-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="hidden md:block sm:absolute size-[15px] fill-black/10 -top-5.75 -right-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="hidden md:block sm:absolute size-[15px] fill-black/10 -bottom-5.75 -left-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="hidden md:block sm:absolute size-[15px] fill-black/10 -bottom-5.75 -right-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <p className="text-sm text-gray-900">© 2026 Radiant Inc.</p>
                </div>
                <div className="relative">
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="hidden md:block sm:absolute size-[15px] fill-black/10 -top-6 -left-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="hidden md:block sm:absolute size-[15px] fill-black/10 -top-6 -right-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="hidden md:block sm:absolute size-[15px] fill-black/10 -bottom-6 -left-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="hidden md:block sm:absolute size-[15px] fill-black/10 -bottom-6 -right-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <div className="flex gap-8 mt-4 md:mt-0">
                    <a
                      ...
                      className="text-gray-950 data-hover:text-gray-950/75 hover:opacity-70"
              ...
              <div className="absolute inset-x-0 z-10">
                <div className="absolute w-full">
                  <div className="absolute inset-x-0 -top-16 md:-top-[72px] border-t border-black/5"></div>
                  <div className="absolute inset-x-0 -top-14 md:-top-16 border-t border-black/5"></div>
                </div>
              </div>
            </div>
          </div>
