...
function Header() {
  return (
    <section className="relative">
      <div className="absolute inset-2 rounded-4xl ring-1 ring-black/5 bg-[linear-gradient(115deg,#fff1be_28%,#ee87cb_70%,#b060ff_100%)] sm:bg-[linear-gradient(145deg,_#fff1be_28%,_#ee87cb_70%,_#b060ff_100%)]"></div>

      <div className="relative px-6 lg:px-[35px] mx-auto">
        <div className="absolute inset-x-0 z-10">
          <div className="absolute w-full ">
            <div className="absolute inset-x-0 top-10 md:top-16 border-t border-black/5"></div>
            <div className="absolute inset-x-0 top-8 md:top-14 border-t border-black/5"></div>
          </div>
        </div>

        <header className="pt-10 md:pt-[73px]">
            ...
            <div className="relative flex items-center gap-6">
              <div className="relative">
                <svg
                  viewBox="0 0 15 15"
                  aria-hidden="true"
                  className="hidden sm:absolute size-[15px] fill-black/10 -top-2 -left-2"
                >
                ...
                <svg
                  viewBox="0 0 15 15"
                  aria-hidden="true"
                  className="hidden sm:absolute size-[15px] fill-black/10 -top-2 -right-2"
                >
                  <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                </svg>
                <svg
                  viewBox="0 0 15 15"
                  aria-hidden="true"
                  className="hidden sm:absolute size-[15px] fill-black/10 -bottom-2 -left-2"
                >
                  <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                </svg>
                <svg
                  viewBox="0 0 15 15"
                  aria-hidden="true"
                  className="hidden sm:absolute size-[15px] fill-black/10 -bottom-2 -right-2"
                >
                  <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                </svg>
              ...
              <a
                href="#"
                className="hidden lg:flex items-center gap-1 rounded-full bg-fuchsia-950/35 px-3 py-1 text-sm    font-medium text-white hover:bg-fuchsia-950/30"
              >
              ...
              {["Blog"].map((item) => (
                <div key={item} className="relative group">
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="absolute size-[14px] fill-black/10 -top-6 -left-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="absolute size-[14px] fill-black/10 -top-6 -right-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="absolute size-[14px] fill-black/10 -bottom-6 -left-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  <svg
                    viewBox="0 0 15 15"
                    aria-hidden="true"
                    className="absolute size-[14px] fill-black/10 -bottom-6 -right-2"
                  >
                    <path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path>
                  </svg>
                  ...
                  <div className="p-0">
                    <NavLink
                      to="/blog"
                      className="px-4 py-3 text-base font-medium text-gray-950 hover:bg-black/5"
                    >
                      {item}
                    </NavLink>
                  </div>
        ...
        <div className="absolute inset-x-0 z-10">
          <div className="absolute w-full ">
            <div className="absolute inset-x-0 -bottom-2 md:-bottom-0 border-b border-black/5"></div>
            <div className="absolute inset-x-0 -bottom-4 md:-bottom-2 border-b border-black/5"></div>
          </div>
        </div>

        <section className="pt-16 pb-24 md:pt-24 md:pb-32 md:pt-[135px] md:pb-48 min-h-[80vh] md:min-h-[auto]">
          <div className="">
            <p className="text-5xl/[0.9] font-medium tracking-tight text-balance text-gray-950 sm:text-8xl/[0.8] md:text-9xl/[0.8]">
              Close every deal.
            </p>
          ...
          <div className="mt-12 flex gap-y-4 gap-x-6 flex-row">
            <div className="px-4 py-2 bg-gray-950 rounded-4xl hover:bg-gray-800">
              <a href="#" className="text-white">
                Get started
              </a>
            </div>
            <div className="px-4 py-2 bg-white/15 shadow-md rounded-4xl">
