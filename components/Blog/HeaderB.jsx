...
import img1 from "../../src/assets/bc1.png";
import img2 from "../../src/assets/bc2.png";
import img3 from "../../src/assets/bc3.png";
import img4 from "../../src/assets/b1.jpg";
import img5 from "../../src/assets/b2.jpg";
import img6 from "../../src/assets/b3.jpg";
...
export default function HeaderB() {
  ...
  const authors = [img4, img5, img6];
  const names = ["Marcus Eldridge", "Nolan Sheffield", "Celeste Vandermark"];
  ...
  return (
    <main className="overflow-hidden">
      <div className="relative mx-auto max-w-7xl">
        <div className="absolute -top-44 -right-60 h-60 w-xl transform-gpu md:right-0 bg-[linear-gradient(115deg,#fff1be_28%,#ee87cb_70%,#b060ff)] rotate-[-10deg] rounded-full blur-3xl"></div>
      </div>
          ...
          <div className="mx-auto max-w-2xl lg:max-w-7xl">
            ...
            <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-3">
              ...
              {post.map((item, index) => (
                <div
                  key={item.id}
                  className="relative flex flex-col rounded-3xl bg-white p-2 shadow-md ring-1 ring-black/5"
                >
