import img1 from "../../src/assets/s-1.svg";
import img2 from "../../src/assets/s-2.svg";
import img3 from "../../src/assets/s-3.svg";
...
function Sales() {
  return (
    <section className="px-6 lg:px-8 pt-10 sm:pt-24">
      <div className="mx-auto">
        <h5 className="font-mono text-xs/5 tracking-widest font-semibold text-gray-500 uppercase">
          Sales
        </h5>
        <h2 className="mt-2 max-w-3xl font-medium text-4xl sm:text-6xl tracking-tighter text-pretty text-gray-950">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
          <div className="max-lg:rounded-t-4xl lg:col-span-3 lg:rounded-tl-4xl relative flex flex-col overflow-hidden rounded-lg bg-white shadow-xs ring-1 ring-black/5">
            <div className="relative h-80 shrink-0">
              <div className="h-80 bg-[url(../../src/assets/s1.png)] bg-size-[1000px_560px] bg-position-[left_-109px_top_-112px] bg-no-repeat"></div>
            ...
            <div className="relative p-10">
              ...
              <h3 className="mt-1 text-2xl/8 font-medium tracking-tight text-gray-950">
                Get perfect clarity
              </h3>
          ...
          <div className="lg:col-span-2 lg:rounded-bl-4xl group relative flex flex-col overflow-hidden rounded-lg bg-white shadow-xs ring-1 ring-black/5 data-dark:bg-gray-800 data-dark:ring-white/15">
                ...
                <div aria-hidden="true" className="flex flex-col gap-2">
                  <div className="group flex h-9 gap-2">
                    <div
                      ...
                      className="rounded-tl-xl flex flex-col items-center justify-center gap-0.5 px-1 py-px rounded-sm bg-white bg-linear-to-t from-black/3 shadow-2xs ring-1 ring-black/10 [:where(&_svg)]:h-3.5 [:where(&_svg)]:fill-gray-600"
                    >
                    ...
                    <div
                      style={{ width: "2.25rem" }}
                      className="flex flex-col items-center justify-center gap-0.5 px-1 py-px rounded-sm bg-white bg-linear-to-t from-black/3 shadow-2xs ring-1 ring-black/10 [:where(&_svg)]:h-3.5 [:where(&_svg)]:fill-gray-600"
                    >
                    ...
                    <div
                      style={{ width: "2.25rem" }}
                      className="rounded-tr-xl flex flex-col items-center justify-center gap-0.5 px-1 py-px rounded-sm bg-white bg-linear-to-t from-black/3 shadow-2xs ring-1 ring-black/10 [:where(&_svg)]:h-3.5 [:where(&_svg)]:fill-gray-600"
                    >
                      <svg viewBox="0 0 12 14">
                  ...
                  <div className="group flex h-9 gap-2">
                    ...
                    >
                      ...
                      <svg viewBox="0 0 7 14">
                        <path d="M4.56 5.434h-.944L1.716 3h1.217L4.56 5.434Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 4 14">
                        <path d="M.768 10.355a.747.747 0 0 1 .763-.757c.229 0 .417.071.564.215.15.143.225.324.225.542a.705.705 0 0 1-.225.532.785.785 0 0 1-.564.21.757.757 0 0 1-.543-.21.713.713 0 0 1-.22-.532ZM1 3.668h1.096L1.97 8.389h-.854L1 3.668Z"></path>
                      </svg>
                      <svg viewBox="0 0 6 14">
                        <path d="M4.263 12H3.108V4.587H3.05l-.673.483c-.22.16-.442.321-.667.482l-.666.489V4.866a161.932 161.932 0 0 1 2.063-1.53h1.155V12Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 7 14">
                        <path d="M6.476 6.434h-1.22l-.36 1.74H6.1l-.145.747H4.746L4.327 11h-.773l.424-2.08H2.302L1.878 11h-.774l.42-2.08H.378l.15-.746h1.156l.354-1.74H.9l.145-.747H2.19l.409-2.019h.778l-.413 2.02h1.676l.413-2.02h.768l-.408 2.02h1.214l-.15.746Zm-3.674-.027-.37 1.789h1.707l.365-1.789H2.802Z"></path>
                      </svg>
                      <svg viewBox="0 0 8 14">
                        <path d="M2.965 8.033v-.996h.895c.305 0 .576-.064.813-.19.241-.128.43-.303.565-.528.135-.224.2-.478.197-.761 0-.42-.146-.76-.438-1.022-.292-.263-.671-.394-1.137-.394a1.83 1.83 0 0 0-.628.102 1.572 1.572 0 0 0-.482.266c-.14.11-.25.237-.33.381-.077.144-.121.296-.134.457h-1.11a2.105 2.105 0 0 1 .705-1.504c.227-.207.507-.373.837-.495.33-.123.713-.186 1.149-.19.55-.005 1.028.09 1.434.285.407.195.724.46.952.793.229.335.347.713.356 1.137.013.406-.07.757-.248 1.053a2.154 2.154 0 0 1-.64.705c-.255.17-.492.273-.712.311v.063c.246.026.512.115.8.267.292.152.544.379.755.68.216.296.328.676.337 1.142.008.376-.064.723-.216 1.04a2.37 2.37 0 0 1-.641.826c-.275.233-.601.413-.978.54-.376.122-.789.184-1.237.184-.576 0-1.075-.098-1.498-.292a2.476 2.476 0 0 1-.984-.8 2.14 2.14 0 0 1-.381-1.124h1.092c.03.229.122.436.279.622.156.182.364.328.622.438.262.106.56.161.895.165.38 0 .71-.067.99-.203.284-.14.502-.33.654-.57.152-.246.226-.524.222-.832a1.469 1.469 0 0 0-.876-1.359 2.09 2.09 0 0 0-.933-.197h-.946Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 8 14">
                        <path d="M3.46 3.68h.774L7 8.31H5.969L3.906 4.716h-.048L1.903 8.31H.883L3.46 3.68Z"></path>
                      </svg>
                      <svg viewBox="0 0 8 14">
                    ...
                    >
                      ...
                      <svg viewBox="0 0 7 14">
                        <path d="M.758 3.336h5.541V4.39L2.757 12H1.532L5.12 4.422v-.07H.758V3.337Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 6 14">
                        <path d="M5.85 8.901H.144V8H5.85v.901Z"></path>
                      </svg>
                      <svg viewBox="0 0 6 14">
                        <path d="M5 8.96H1V7.932h4V8.96Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 8 14">
                        <path d="M4.47 9.029v2.818h-.946V9.03H.94v-.952h2.584V5.404h.946v2.673h2.59v.952H4.47Z"></path>
                      </svg>
                      <svg viewBox="0 0 8 14">
                        <path d="M6.679 10.177H1.315v-.92h5.364v.92Zm0-2.361H1.315v-.933h5.364v.933Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "4rem" }}
                  ...
                  <div className="group flex h-9 gap-2">
                    ...
                    >
                      <svg viewBox="0 0 12 14">
                        <path d="M3.958 11.999H2.837L.273 2.668h1.45l1.695 7.424h.068l1.826-7.424h1.23l1.832 7.424h.068l1.696-7.424h1.442l-2.557 9.331H7.896l-1.942-7.3H5.9l-1.941 7.3Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 8 14">
                        <path d="M6.932 10.892v1.107h-5.64V2.668h5.64v1.107H2.543v2.926h4.143v1.08H2.543v3.11h4.389Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 8 14">
                        <path d="M4.396 11.999H3.138V3.782H.32V2.668h6.884v1.114h-2.81V12Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 8 14">
                        <path d="M4.553 11.999H3.295V8.027L.178 2.668h1.428l2.29 4.122h.062l2.297-4.122H7.67L4.553 8.021v3.978Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 4 14">
                        <path d="M2.55 11.999H1.292V2.668H2.55v9.331Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 5 14">
                        <path d="M3.343 7.85v-.158c-.378-.04-.67-.182-.875-.423-.2-.247-.301-.611-.301-1.094V4.322c0-.332-.048-.604-.144-.813a.89.89 0 0 0-.464-.465c-.22-.1-.515-.15-.89-.15H.404V1.93h.41c.53 0 .98.073 1.354.218.374.146.659.383.854.711.201.324.301.761.301 1.313v1.586c0 .47.073.816.219 1.039.15.223.458.335.923.335V8.41c-.465 0-.773.112-.923.335-.146.219-.219.565-.219 1.04v1.777c0 .551-.1.995-.3 1.333a1.72 1.72 0 0 1-.855.738c-.374.155-.825.232-1.354.232h-.41v-.964H.67c.374 0 .67-.052.889-.157a.887.887 0 0 0 .464-.471c.096-.21.144-.48.144-.807V9.38c0-.479.1-.846.3-1.1.206-.256.498-.4.876-.431Z"></path>
                      </svg>
                      <svg viewBox="0 0 5 14">
                        <path d="M.403 1.93h3.104v11.935H.403v-.93h1.928V2.86H.403v-.93Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 5 14">
                        <path d="M2.974 13.865H1.887V1.93h1.087v11.935Z"></path>
                      </svg>
                      <svg viewBox="0 0 5 14">
                        <path d="M4.69 13.865H3.54L.178 1.93h1.141l3.37 11.935Z"></path>
                      </svg>
                    </div>
                  </div>
                  <div className="group flex h-9 gap-2">
                    ...
                    >
                      <svg viewBox="0 0 9 14">
                        <path d="M1.654 11.999H.35L3.65 2.668h1.306l3.295 9.331H6.925l-.916-2.762H2.57L1.654 12Zm2.66-7.889h-.048L2.898 8.232h2.79L4.313 4.11Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    <div
                      style={{
                        width: "2.25rem",
                        boxShadow:
                          "rgb(255, 255, 255) 0px 0px 0px 0px, rgba(47, 127, 221, 0.8) 0px 0px 0px 1px, rgba(47, 127, 221, 0.15) 0px 0px 3px 3px, rgba(47, 127, 221, 0.1) 0px 0px 0px 0px",
                      }}
                      className="flex flex-col items-center justify-center gap-0.5 px-1 py-px rounded-sm bg-white bg-linear-to-t from-black/3 shadow-2xs ring-1 ring-black/10 [:where(&_svg)]:h-3.5 [:where(&_svg)]:fill-gray-600"
                    >
                      <svg viewBox="0 0 10 14">
                        <path d="M1.292 2.668h3.035c.907 0 1.664.178 2.27.533.61.351 1.068.873 1.374 1.566.31.692.465 1.547.465 2.563 0 1.012-.155 1.866-.465 2.564-.306.692-.764 1.216-1.374 1.572-.606.355-1.363.533-2.27.533H1.292V2.668Zm1.258 1.1v7.124h1.688c.483 0 .907-.073 1.272-.22.364-.15.665-.373.902-.67.237-.295.415-.664.533-1.106.123-.443.185-.962.185-1.56 0-.792-.107-1.453-.321-1.982-.21-.528-.529-.925-.957-1.189-.429-.264-.967-.396-1.614-.396H2.55Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 8 14">
                        <path d="M2.55 11.999H1.292V2.668H6.85v1.114h-4.3V6.9h3.937V8H2.55v3.999Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 10 14">
                        <path d="M8.429 11.999H7.17V7.727H2.55v4.272H1.292V2.668H2.55v3.951h4.62V2.668H8.43v9.331Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 9 14">
                        <path d="M8.08 2.668 4.614 6.646 8.258 12H6.672L3.678 7.508 2.55 8.745V12H1.292V2.668H2.55v4.478h.054L6.61 2.668h1.47Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 8 14">
                        <path d="M6.815 10.878v1.121H1.292V2.668H2.55v8.21h4.265Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 7 14">
                        <path d="M1.955 4H3.07l-.615 3.965h-1.45L1.956 4ZM4.86 4h1.115l-.616 3.965H3.91L4.86 4Z"></path>
                      </svg>
                      <svg viewBox="0 0 5 14">
                        <path d="M2.105 2.668H3.22l-.616 3.965H1.155l.95-3.965Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "4.5rem" }}
                  ...
                  <div className="group flex h-9 gap-2">
                    ...
                    >
                      <svg viewBox="0 0 9 14">
                        <path d="M.752 11.999v-.868l4.942-7.287v-.069H.923V2.668h6.33v.868l-4.915 7.28v.076h5.031v1.107H.752Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 9 14">
                        <path d="m7.882 2.668-3.083 4.71 3.021 4.621H6.31l-2.29-3.65H3.95l-2.31 3.65H.226L3.26 7.296.267 2.668h1.51l2.304 3.664h.068l2.29-3.664h1.443Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 9 14">
                        <path d="M3.637 11.999.294 2.668h1.435l2.543 7.855h.069l2.536-7.855h1.422l-3.343 9.331h-1.32Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 10 14">
                        <path d="M2.53 11.999H1.291V2.668h1.19l4.614 7.178h.061V2.668h1.238v9.331h-1.19L2.577 4.814H2.53V12Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 12 14">
                        <path d="M2.46 11.999H1.32V2.668h1.237l3.042 7.15h.04l3.036-7.15h1.23v9.331H8.764V5.218h-.069l-2.57 5.96H5.1l-2.578-5.96h-.061v6.781Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 8 14">
                        <path d="M.978 8.993V8.01l5.892-3.52V5.8L2.297 8.426v.061l4.573 2.489v1.298L.978 8.994Z"></path>
                      </svg>
                      <svg viewBox="0 0 4 14">
                        <path d="M1.825 10.965H.711L1.326 7h1.45l-.95 3.965Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    >
                      <svg viewBox="0 0 8 14">
                        <path d="M6.87 8.009v.984L.984 12.274v-1.298l4.574-2.489v-.061L.984 5.8V4.488l5.886 3.52Z"></path>
                      </svg>
                      <svg viewBox="0 0 5 14">
                        <path d="M1.06 8.991c0-.291.095-.528.287-.71A.953.953 0 0 1 2.037 8c.283 0 .52.093.711.28a.951.951 0 0 1 .287.711.927.927 0 0 1-.287.69.991.991 0 0 1-.71.274.965.965 0 0 1-.691-.273.927.927 0 0 1-.287-.69Z"></path>
                      </svg>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                    ...
                    <div
                      ...
                      className="flex flex-col items-center justify-center gap-0.5 px-1 py-px rounded-sm bg-white bg-linear-to-t from-black/3 shadow-2xs ring-1 ring-black/10 [:where(&_svg)]:h-3.5 [:where(&_svg)]:fill-gray-600"
                    >
                      <svg viewBox="0 0 18 14" className="mt-auto ml-auto">
                        <path d="M15.91 5.902v-1.03h.7v1.03h.93v.575h-.93v2.367c0 .242.048.405.144.488.096.08.27.121.52.121.049 0 .107-.002.175-.008l.149-.011V10a4.384 4.384 0 0 1-.504.035c-.326 0-.574-.042-.746-.125A.683.683 0 0 1 16 9.52a2.046 2.046 0 0 1-.094-.672V6.477h-.629v-.575h.633ZM12.898 10V6.477h-.691v-.575h.691v-.41c0-.396.1-.686.301-.87.2-.188.53-.282.989-.282a4.79 4.79 0 0 1 .468.023v.57a1.49 1.49 0 0 0-.168-.011 6.391 6.391 0 0 0-.199-.004c-.242 0-.418.044-.527.133-.11.086-.164.251-.164.496v.355h.953v.575h-.946V10h-.707ZM10.348 10V5.89h.707V10h-.707Zm-.149-5.375c0-.143.047-.26.14-.352a.498.498 0 0 1 .356-.136c.149 0 .271.045.367.136a.462.462 0 0 1 .145.352c0 .14-.048.257-.145.348a.513.513 0 0 1-.367.136.498.498 0 0 1-.355-.136.464.464 0 0 1-.14-.348ZM5.488 10V4.387h.707v2.25h.035c.03-.094.088-.205.176-.332.091-.13.226-.242.403-.336.177-.097.407-.145.691-.145.398 0 .728.115.988.344.263.23.395.574.395 1.035V10h-.707V7.426c0-.216-.038-.397-.114-.543a.725.725 0 0 0-.316-.332 1 1 0 0 0-.48-.11.998.998 0 0 0-.59.168 1.033 1.033 0 0 0-.36.457c-.08.193-.12.408-.12.645V10h-.708ZM1.21 7.07c0-.291.073-.528.216-.71.146-.186.334-.32.566-.407.235-.086.485-.129.75-.129.297 0 .555.048.774.145.221.096.393.23.515.402a1 1 0 0 1 .184.602h-.656a.576.576 0 0 0-.106-.282.67.67 0 0 0-.277-.222 1.02 1.02 0 0 0-.457-.09c-.24 0-.438.053-.594.16a.527.527 0 0 0-.23.461.45.45 0 0 0 .093.297.677.677 0 0 0 .242.176c.102.041.213.074.333.097.12.024.236.046.351.067.258.044.492.105.703.183.214.076.384.19.512.34.128.149.191.357.191.625 0 .274-.069.507-.207.7-.135.19-.327.334-.574.433a2.284 2.284 0 0 1-.86.148c-.304 0-.572-.044-.804-.132a1.21 1.21 0 0 1-.543-.387 1.005 1.005 0 0 1-.195-.625h.691c.018.122.06.228.125.316a.63.63 0 0 0 .285.207c.125.047.283.07.473.07.216 0 .39-.03.523-.09a.657.657 0 0 0 .297-.234.583.583 0 0 0 .094-.324c0-.153-.046-.27-.137-.351a.902.902 0 0 0-.37-.184 6.195 6.195 0 0 0-.52-.121 5.53 5.53 0 0 1-.7-.188 1.165 1.165 0 0 1-.5-.332c-.125-.145-.187-.352-.187-.62Z"></path>
                      </svg>
                    </div>
                  </div>
                  <div className="group flex h-9 gap-2">
                    ...
                    >
                      <svg viewBox="0 0 13 14" className="mt-0.5 ml-auto">
                        <path d="m1.582 8.568 4.254-4.347a.604.604 0 0 1 .445-.2.54.54 0 0 1 .235.053.55.55 0 0 1 .199.147l4.26 4.347c.113.114.17.252.17.416a.56.56 0 0 1-.287.498.565.565 0 0 1-.293.077.573.573 0 0 1-.422-.17L5.994 5.135h.569L2.407 9.389a.554.554 0 0 1-.416.17.597.597 0 0 1-.299-.077.573.573 0 0 1-.234-.726.678.678 0 0 1 .123-.188Z"></path>
                      </svg>
                    ...
                    <div
                      ...
                      className="flex flex-col items-center justify-center gap-0.5 px-1 py-px rounded-sm bg-white bg-linear-to-t from-black/3 shadow-2xs ring-1 ring-black/10 [:where(&_svg)]:h-3.5 [:where(&_svg)]:fill-gray-600"
                    >
                      <svg viewBox="0 0 12 14" className="mt-0.5 mr-auto">
                        <path d="M3.796 6.68h-.844a1.747 1.747 0 0 1-1.517-.85 1.677 1.677 0 0 1-.235-.876c0-.322.078-.616.235-.883a1.74 1.74 0 0 1 1.517-.876 1.74 1.74 0 0 1 1.51.876c.157.267.235.561.235.883v.844h1.949v-.844c0-.322.078-.616.235-.883.156-.27.366-.484.628-.64.267-.157.563-.236.889-.236a1.74 1.74 0 0 1 1.504.876c.161.267.242.561.242.883 0 .321-.08.613-.242.876-.156.262-.368.47-.634.622a1.7 1.7 0 0 1-.87.228h-.85v1.974h.85c.317 0 .607.079.87.235.266.152.478.36.634.622.161.258.242.548.242.87 0 .326-.08.622-.242.889a1.823 1.823 0 0 1-.634.634 1.665 1.665 0 0 1-.87.235c-.326 0-.622-.078-.889-.235a1.84 1.84 0 0 1-.628-.634 1.722 1.722 0 0 1-.235-.89v-.843H4.697v.844c0 .326-.078.622-.235.889a1.823 1
-.05.323 0 .601.07.836.214.234.143.415.346.543.61.127.262.191.575.191.937v.707c0 .364-.065.678-.195.941a1.407 1.407 0 0 1-.551.61 1.62 1.62 0 0 1-.848.214Zm-.144-.606c.219 0 .403-.05.555-.152a.955.955 0 0 0 .351-.438c.08-.193.121-.426.121-.699V7.73c0-.276-.04-.51-.12-.703a.944.944 0 0 0-.356-.441 1.024 1.024 0 0 0-.57-.152c-.217 0-.404.048-.563.144a.958.958 0 0 0-.363.414c-.084.177-.125.39-.125.637v.715c0 .219.044.413.132.582a.994.994 0 0 0 .38.39c.16.094.347.141.558.141ZM4.348 5.824c.34 0 .644.072.91.215.268.14.479.348.633.621.153.271.23.597.23.977v.61c0 .385-.077.714-.23.987-.154.271-.365.478-.633.621-.266.141-.57.211-.91.211-.347 0-.654-.07-.922-.21a1.542 1.542 0 0 1-.63-.618c-.15-.273-.226-.604-.226-.992v-.605c0-.373.077-.694.23-.965.154-.271.365-.48.634-.63.268-.148.573-.222.914-.222Zm.004.602a1 1 0 0 0-.575.164 1.058 1.058 0 0 0-.37.45c-.087.19-.13.41-.13.66v.495c0 .256.042.478.125.668.084.19.205.339.364.446.161.106.356.16.586.16a.994.994 0 0 0 .574-.16.986.986 0 0 0 .36-.446c.082-.19.124-.412.124-.668V7.7c0-.252-.043-.474-.129-.664a.974.974 0 0 0-.93-.61Z"></path>
                      </svg>
                    </div>
                    <div
                    ...
                    >
                      <svg viewBox="0 0 7 14">
                        <path d="M5.059 10.004c0 .096-.046.169-.137.219a.277.277 0 0 1-.267 0L1.333 8.576a.23.23 0 0 1-.116-.15.391.391 0 0 1 0-.206.255.255 0 0 1 .123-.15l3.322-1.648c.082-.04.169-.036.26.014.091.045.137.116.137.212v3.356Z"></path>
                      </svg>
                    </div>
                    <div className="grid gap-px rounded-sm bg-black/10 ring-1 ring-black/10 *:ring-0">
                      <div
                        style={{ width: "2.25rem" }}
                        className="rounded-b-[1px] flex flex-col items-center justify-center gap-0.5 px-1 py-px rounded-sm bg-white bg-linear-to-t from-black/3 shadow-2xs ring-1 ring-black/10 [:where(&_svg)]:h-3.5 [:where(&_svg)]:fill-gray-600"
                      >
                        <svg viewBox="0 0 7 14">
                          <path d="M5.045 10.168H1.682a.224.224 0 0 1-.164-.069.35.35 0 0 1-.082-.164.263.263 0 0 1 .02-.178l1.661-3.595a.211.211 0 0 1 .144-.11.316.316 0 0 1 .205 0 .211.211 0 0 1 .143.11l1.662 3.595c.045.082.043.171-.007.267-.046.096-.119.144-.22.144Z"></path>
                        </svg>
                      </div>
                      <div
                        style={{ width: "2.25rem" }}
                        className="rounded-t-[1px] flex flex-col items-center justify-center gap-0.5 px-1 py-px rounded-sm bg-white bg-linear-to-t from-black/3 shadow-2xs ring-1 ring-black/10 [:where(&_svg)]:h-3.5 [:where(&_svg)]:fill-gray-600"
                      >
                        <svg viewBox="0 0 7 14">
                          <path d="M1.682 6.14h3.363a.21.21 0 0 1 .164.069.35.35 0 0 1 .082.164.263.263 0 0 1-.02.178L3.608 10.14a.234.234 0 0 1-.143.116.392.392 0 0 1-.205 0 .234.234 0 0 1-.144-.116L1.456 6.55a.29.29 0 0 1 .007-.266c.05-.096.123-.143.219-.143Z"></path>
                        </svg>
                      </div>
                    </div>
                    <div
                      style={{ width: "2.25rem" }}
                      className="rounded-br-xl flex flex-col items-center justify-center gap-0.5 px-1 py-px rounded-sm bg-white bg-linear-to-t from-black/3 shadow-2xs ring-1 ring-black/10 [:where(&_svg)]:h-3.5 [:where(&_svg)]:fill-gray-600"
                    >
                      <svg viewBox="0 0 7 14">
                        <path d="M1.668 10.004V6.648c0-.096.043-.167.13-.212a.278.278 0 0 1 .266-.014L5.387 8.07a.227.227 0 0 1 .123.15.392.392 0 0 1 0 .205.23.23 0 0 1-.116.15L2.07 10.224a.277.277 0 0 1-.266 0c-.091-.05-.137-.123-.137-.219Z"></path>
                      </svg>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative p-10">
              <h4 className="font-mono text-xs/5 font-semibold tracking-widest text-gray-500 uppercase data-dark:text-gray-400">
                Speed
              </h4>
            ...
            <div className="relative h-80 shrink-0">
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    style={{ width: "528px", height: "528px", opacity: "0.3" }}
                    className="absolute
    rounded-full 
    bg-[radial-gradient(circle,transparent_25%,color-mix(in_lab,lab(54.1736%_13.3369_-74.6839)_30%,transparent)_100%)] 
    ring-1 ring-blue-500/10 ring-inset"
                  ></div>

                  <div
                    style={{ width: "400px", height: "400px", opacity: "0.5" }}
                    className="absolute
    rounded-full 
    bg-[radial-gradient(circle,transparent_25%,color-mix(in_lab,lab(54.1736%_13.3369_-74.6839)_30%,transparent)_100%)] 
    ring-1 ring-blue-500/10 ring-inset"
                  ...
                  <div
                    style={{ width: "272px", height: "272px", opacity: "0.5" }}
                    className="absolute
    rounded-full 
    bg-[radial-gradient(circle,transparent_25%,color-mix(in_lab,lab(54.1736%_13.3369_-74.6839)_30%,transparent)_100%)] 
    ring-1 ring-blue-500/10 ring-inset"
                  ...
                  <div
                    style={{ width: "144px", height: "144px", opacity: "1 " }}
                    className="absolute
    rounded-full 
    bg-[radial-gradient(circle,transparent_25%,color-mix(in_lab,lab(54.1736%_13.3369_-74.6839)_30%,transparent)_100%)] 
    ring-1 ring-blue-500/10 ring-inset"
                  ...
                  <div className="absolute inset-0 bg-linear-to-t from-white to-35%"></div>
                </div>

                  <div className="absolute top-full left-full h-full w-[418px] -translate-x-1/2 -translate-y-1/2">
                    <div className="absolute top-[60%] left-[58%] -translate-x-1/2 -translate-y-1/2 flex size-16 items-center justify-center rounded-full bg-white shadow-sm ring-1 ring-black/5">
                      <svg
                        viewBox="0 0 34 34"
                        fill="none"
            ...
            <div className="relative p-10">
              ...
              <p className="mt-2 max-w-[600px] text-sm/6 text-gray-600 group-data-dark:text-gray-400">
                Bypass those inconvenient privacy laws to source leads from the
    ...
    bg-no-repeat"
                ...
                <div className="absolute inset-0">
                  <div
                    style={{ "--offset": "-128px", top: "96px" }}
                    className="absolute left-[calc(50%+var(--offset))] size-[38px]
        ...
        transition-all duration-700 ease-out delay-100"
                  >
                    <svg viewBox="0 0 38 38" className="absolute size-full">
                      <path
        ...
        transition-all duration-700 ease-out delay-500"
            ...
            <div className="relative p-10">
              ...
              <p className="mt-2 max-w-[600px] text-sm/6 text-gray-600 group-data-dark:text-gray-400">
                Radiant helps you sell in locations currently under
